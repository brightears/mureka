/**
 * Generate Acid Jazz tracks using prompt-based generation
 */
...
const PROMPT = 'acid jazz, funk groove, Hammond organ, fender rhodes, funky bass, breakbeat drums, syncopated rhythm, saxophone, brass section, 105 BPM, groovy, danceable, club jazz, 90s London sound, no vocals, professional studio recording';
const OUTPUT_DIR = '/Users/norbert/Library/CloudStorage/GoogleDrive-platzer.norbert@gmail.com/My Drive/Mureka/tracks/Acid Jazz - Prompt Test';
const GENRE = 'acid jazz';
...
async function main() {
  ...
  console.log(`Generating ${count} generations (${count * 2} tracks) of acid jazz...`);
