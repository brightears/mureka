/**
 * Generate Smooth Jazz Urban Soft tracks using prompt-based generation
 */
...
const PROMPT = 'smooth jazz, urban R&B influence, soft mellow groove, contemporary jazz, electric piano rhodes, smooth saxophone, clean guitar, groovy bass line, soft programmed drums, downtempo 95 BPM, sophisticated, romantic, no vocals, professional studio recording';
const OUTPUT_DIR = '/Users/norbert/Library/CloudStorage/GoogleDrive-platzer.norbert@gmail.com/My Drive/Mureka/tracks/Smooth Jazz Urban Soft';
...
async function main() {
  ...
  console.log(`Generating ${count} generations (${count * 2} tracks) of smooth jazz urban soft...`);
